...
# # MEASURES
  ...
  measure: sum_allitems_quantity_shipped {
    ...
    drill_fields: [sales_channel, world_region, order_number, sku, sum_allitems_quantity_shipped]
  }
  ...
  measure: sum_bundle_quantity_shipped {
    ...
    drill_fields: [sales_channel, world_region, order_number, sku, sum_bundle_quantity_shipped]
  }
  ...
  measure: sum_ceilingmount_quantity_shipped {
    ...
    drill_fields: [sales_channel, world_region, order_number, sku, sum_ceilingmount_quantity_shipped]
  }
  ...
  measure: sum_cuecards_quantity_shipped {
    ...
    drill_fields: [sales_channel, world_region, order_number, sku, sum_cuecards_quantity_shipped]
  }
  ...
  measure: sum_hardcase_quantity_shipped {
    ...
    drill_fields: [sales_channel, world_region, order_number, sku, sum_hardcase_quantity_shipped]
  }
  ...
  measure: sum_hq_quantity_shipped {
    ...
    drill_fields: [sales_channel, world_region, order_number, sku, sum_hq_quantity_shipped]
  }
  ...
  measure: sum_linecord_quantity_shipped {
    ...
    drill_fields: [sales_channel, world_region, order_number, sku, sum_linecord_quantity_shipped]
  }
  ...
  measure: sum_lockadapter_quantity_shipped {
    ...
    drill_fields: [sales_channel, world_region, order_number, sku, sum_lockadapter_quantity_shipped]
  }
  ...
  measure: sum_markers_quantity_shipped {
    ...
    drill_fields: [sales_channel, world_region, order_number, sku, sum_markers_quantity_shipped]
  }
  ...
  measure: sum_mic_quantity_shipped {
    ...
    drill_fields: [sales_channel, world_region, order_number, sku, sum_mic_quantity_shipped]
  }
  ...
  measure: sum_mo3_quantity_shipped {
    ...
    drill_fields: [sales_channel, world_region, order_number, sku, sum_mo3_quantity_shipped]
  }
  ...
  measure: sum_og_quantity_shipped {
    ...
    drill_fields: [sales_channel, world_region, order_number, sku, sum_og_quantity_shipped]
  }
  ...
  measure: sum_owlcare_quantity_shipped {
    ...
    drill_fields: [sales_channel, world_region, order_number, sku, sum_owlcare_quantity_shipped]
  }
  ...
  measure: sum_powersupply_quantity_shipped {
    ...
    drill_fields: [sales_channel, world_region, order_number, sku, sum_powersupply_quantity_shipped]
  }
  ...
  measure: sum_pro_quantity_shipped {
    ...
    drill_fields: [sales_channel, world_region, order_number, sku, sum_pro_quantity_shipped]
  }
  ...
  measure: sum_raas_quantity_shipped {
    ...
    drill_fields: [sales_channel, world_region, order_number, sku, sum_raas_quantity_shipped]
  }
  ...
  measure: sum_subscription_quantity_shipped {
    ...
    drill_fields: [sales_channel, world_region, order_number, sku, sum_subscription_quantity_shipped]
  }
  ...
  measure: sum_tablemount_quantity_shipped {
    ...
    drill_fields: [sales_channel, world_region, order_number, sku, sum_tablemount_quantity_shipped]
  }
  ...
  measure: sum_tripod_quantity_shipped {
    ...
    drill_fields: [sales_channel, world_region, order_number, sku, sum_tripod_quantity_shipped]
  }
  ...
  measure: sum_usbextension_quantity_shipped {
    ...
    drill_fields: [sales_channel, world_region, order_number, sku, sum_usbextension_quantity_shipped]
  }
  ...
  measure: sum_usbconversioncable_quantity_shipped {
    ...
    drill_fields: [sales_channel, world_region, order_number, sku, sum_usbconversioncable_quantity_shipped]
  }
  ...
  measure: sum_wbo_quantity_shipped {
    ...
    drill_fields: [sales_channel, world_region, order_number, sku, sum_wbo_quantity_shipped]
  }
  ...
  measure: sum_wbtags_quantity_shipped {
    ...
    drill_fields: [sales_channel, world_region, order_number, sku, sum_wbtags_quantity_shipped]
  }
  ...
  measure: sum_owls_quantity_shipped {
    ...
    drill_fields: [sales_channel, world_region, order_number, sku, sum_owls_quantity_shipped]
  }
  ...
  measure: sum_hardware_quantity_shipped {
    ...
    drill_fields: [sales_channel, world_region, order_number, sku, sum_hardware_quantity_shipped]
  }
