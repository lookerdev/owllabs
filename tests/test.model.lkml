...
include: "/tests/meeting_records-test.view.lkml"
...
explore: meeting_records_test {
  ...
  join: device_view {
    ...
    sql_on: ${meeting_records_test.deviceuuid} = ${device_view.uuid} ;;
  }
  join: devices {
    type: left_outer
    relationship: many_to_one
    sql_on: ${meeting_records_test.deviceuuid} = ${devices.deviceuuid} ;;
  }
  join:  device_registrations {
    type: left_outer
    relationship: many_to_many # this will change once I remove the funky registration dupes
    sql_on: ${meeting_records_test.deviceuuid} = ${device_registrations.deviceuuid} ;;
  }
